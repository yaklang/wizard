    ...
    onSuccess: async (res) => {
      if (res.data.status) {
        ...
        const toLowerCaseVerificationCode =
          verificationCode && verificationCode.replace(/[A-Za-z]/g, (char: string) => char.toLowerCase())
        loginFn({
          ...formValues,
      ...
      <div className="flex h-full relative w-full z-1">
        ...
        >
          ...
          <Form form={form} onFinish={onFinish}>
            ...
            >
              <Password placeholder="请输入密码" className="h-[52px] rounded-[12px] bg-[#F8F8F8]" />
            </Item>
            <div className="relative">
              ...
              <div className="absolute right-3 top-2.5">
                {!loading ? (
                  ...
                  <Spin spinning={loading} className="translate-y-1" />
                )}
              </div>
            </div>
            <Item noStyle>
