import React, { useEffect, useMemo, useRef, useState, type WheelEvent } from 'react'
          ...
          <div className={styles['content']}>
            ...
            {contentInfo && (
              <YakCodemirror
                ...
                highLight={{
                  from: {
                    line: contentInfo.code_range.start_line - contentInfo.code_range.source_code_line,
          ...
          if (item.Key === 'graph_line') {
            try {
              ...
              if (graph_info.length > 0 && graph_info.length <= 10) {
                const expendKey: string[] = graph_info.map((_, index) => `路径${index + 1}`)
