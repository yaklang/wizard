...
export const LeftSideBar: React.FC<LeftSideBarProps> = (props) => {
    const { fileTreeLoad, isUnShow, active } = props;
                ...
                {rendered.current.has('audit') && (
                    ...
                    >
                        <YakitResizeBox
                            ...
                            secondNode={
                                <AuditCode setOnlyFileTree={setOnlyFileTree} />
                            }
                            {...ResizeBoxProps}
                        />
                    </div>
