...
const ColumnsOperateRender: FC<{
  ...
  setDeleteValues: React.Dispatch<React.SetStateAction<TDeleteValues | undefined>>
    ...
    if (render.report_id) {
      ...
      setDeleteValues((values) => ({
        report_title: {
          ...
          ids: values?.report_title?.ids.filter((it) => it !== render.report_id) ?? [],
        },
      }))
      localRefrech({
        operate: 'delete',
