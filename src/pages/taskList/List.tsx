...
import { getTaskList, getScriptTaskGroup } from '@/apis/task';
...
import { StartUpScriptModal as CreateTaskModal } from '../TaskScript/compoment/StartUpScriptModal';
...
const TaskList: FC = () => {
    ...
    return (
        <div className="flex align-start h-full">
            ...
            <WizardTable
                rowKey={'id'}
                columns={commonTasksColumns(headerGroupValue, page.refresh)}
                page={page}
                tableHeader={{
                    tableHeaderGroup: (
                        <Group
                    ...
                    options: {
                        trigger: (
                            <Button
                                type="primary"
                                onClick={() =>
                                    openCreateTaskModalRef.current?.open()
                                }
                            >
                                <PlusOutlined />
                                创建任务
