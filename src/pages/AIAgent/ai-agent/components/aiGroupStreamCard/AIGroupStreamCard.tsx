import type { ChatReferenceMaterialPayload, ReActChatElement } from '@/pages/AIAgent/ai-re-act/hooks/aiRender'
...
const AIStreamNode: FC<{
  ...
  return (
    <div className={styles['single-stream-text']}>
      ...
      >
        {!!stream.reference?.length && <Code code={stream.reference || []} style={{ maxHeight: '500px' }} />}
      </YakitModal>
