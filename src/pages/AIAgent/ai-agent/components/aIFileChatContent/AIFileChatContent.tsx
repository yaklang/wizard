...
const AIFileChatContent: FC<AIFileChatContentProps> = ({ qs, extraValue }) => {
                        ...
                        {attachedFilePathList.map((file) => {
                            return (
                                <div
                                    ...
                                    tabIndex={0}
                                    // onClick={() =>
                                    //     onOpenLocalFileByPath(file.path)
                                    // }
                                >
                                    <div
                                        className={
