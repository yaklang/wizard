...
import type { YakQueryHTTPFlowResponse } from '@/compoments/HTTPFlowTable/HTTPFlowTable'
...
export const grpcQueryAIEvent: APIFunc<AIEventQueryRequest, AIEventQueryResponse> = (param, hiddenError) => {
  return axios.post<AIEventQueryRequest, AIEventQueryResponse>('/agent/event/query', param).catch((e) => {
