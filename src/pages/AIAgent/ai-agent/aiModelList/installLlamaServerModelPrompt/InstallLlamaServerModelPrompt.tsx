...
export const InstallLlamaServer: React.FC<InstallLlamaServerProps> = React.memo(
    (props) => {
        const {
            // onFinished,
            onCancel,
            ...
            <YakitHint
                ...
                heardIcon={
                    <SolidCloudDownloadIcon
                        style={{ color: 'var(--Colors-Use-Warning-Primary)' }}
                    />
                }
                onCancel={onBack}
...
export const DownloadLlamaServerModelPrompt: React.FC<DownloadLlamaServerModelPromptProps> =
    React.memo((props) => {
