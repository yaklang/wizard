...
import { AITaskStatus } from '../ai-re-act/hooks/grpcApi';
import {
 ...
 */
export const generateTaskChatExecution: (
    info?: AIAgentGrpcApi.PlanTask,
) => AIAgentGrpcApi.PlanTask = (info) => {
...
export type AIReviewRuleOptionsType =
    (typeof AIReviewRuleOptions)[number]['value'];
export const AIReviewRuleIconMap: Record<
...
> = {
    manual: {
        ...
        activeIcon: (
            <OutlinePointerIcon
                style={{ color: 'var(--Colors-Use-Neutral-Text-2-Primary)' }}
            />
        ),
    },
    yolo: {
        ...
        activeIcon: (
            <OutlineEarOffIcon
                style={{ color: 'var(--Colors-Use-Error-Primary)' }}
            />
        ),
    },
    ai: {
