...
export type IsLlamaServerReadyResponse = GeneralResponse;
...
export type IsLocalModelReadyResponse = GeneralResponse;
...
export type UpdateLocalModelRequest = AddLocalModelRequest;
