            ...
            <YakitDropdownMenu
              menu={{
                data: [
                  {
                    key: '1',
                    label: renderClearConfirm('一天前', '确定要清除一天前的会话吗？此操作不可恢复', () =>
                      handleClearChatByDays(1),
                    ),
                  },
                  {
                    key: '7',
                    label: renderClearConfirm('一周前', '确定要清除一周前的会话吗？此操作不可恢复', () =>
                      handleClearChatByDays(7),
                    ),
                  },
                  {
                    key: '30',
                    label: renderClearConfirm('30天前', '确定要清除30天前的会话吗？此操作不可恢复', () =>
                  ...
                  {
                    key: 'all',
                    label: renderClearConfirm('清空全部', '确定要清除全部会话吗？此操作不可恢复', handleClearAllChat),
                  },
                ],
              }}
              dropdown={{
