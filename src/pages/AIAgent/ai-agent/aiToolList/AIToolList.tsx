...
const AIToolList: React.FC<AIToolListProps> = React.memo(() => {
...
const AIToolListItem: React.FC<AIToolListItemProps> = React.memo((props) => {
    ...
    const onEdit = useMemoizedFn((e) => {
        ...
        emiter.emit(
            ...
            JSON.stringify({
                ...
                } satisfies AIToolEditorPageInfoProps,
            }),
        );
    });
    ...
    return (
        ...
        >
            <div
                className={styles['ai-tool-list-item-content']}
                onClick={onToolClick}
            >
                <div className={styles['ai-tool-list-item-heard']}>
                    <div className={styles['ai-tool-list-item-heard-name']}>
                        ...
                        <span
                            className={
                                styles['ai-tool-list-item-heard-name-text']
                            }
                        >
                    ...
                    >
                        {item.IsFavorite ? (
                            <YakitButton
                                ...
                                icon={
                                    <SolidStarIcon
                                        className={styles['star-icon-active']}
                                    />
                                }
                                onClick={onFavorite}
                            />
