...
export const grpcGetAIToolList: APIFunc<
    GetAIToolListRequest,
    GetAIToolListResponse
> = (params, hiddenError) => {
    return new Promise((resolve, reject) => {
        ipcRenderer
            ...
            .catch((err: any) => {
                if (!hiddenError)
                    yakitNotify('error', 'grpcGetAIToolList 失败:' + err);
                reject(err);
            });
    });
};

export const grpcGetAIToolById: APIFunc<number, AITool | null> = (
    toolId,
    hiddenError,
) => {
    return new Promise((resolve, reject) => {
        ...
        ipcRenderer
            ...
            .catch((err: any) => {
                if (!hiddenError)
                    yakitNotify('error', 'grpcGetAIToolByName 失败:' + err);
                reject(err);
            });
    });
};

export const grpcToggleAIToolFavorite: APIFunc<
    ToggleAIToolFavoriteRequest,
    ToggleAIToolFavoriteResponse
> = (params, hiddenError) => {
    return new Promise((resolve, reject) => {
        ipcRenderer
            ...
            .catch((err: any) => {
                if (!hiddenError)
                    yakitNotify(
                        'error',
                        'grpcToggleAIToolFavorite 失败:' + err,
                    );
                reject(err);
            });
    });
...
export const grpcDeleteAITool: APIFunc<
    DeleteAIToolRequest,
    ToggleAIToolFavoriteResponse
> = (params, hiddenError) => {
    return new Promise((resolve, reject) => {
        ipcRenderer
            ...
            .catch((err: any) => {
                if (!hiddenError)
                    yakitNotify('error', 'grpcDeleteAITool 失败:' + err);
                reject(err);
            });
    });
};
