...
import type {
    AIMemoryContentProps,
    AIMemoryEchartsProps,
    AIMemoryListProps,
    AIMemoryScoreEchartsProps,
} from './type';
...
const AIMemoryList: React.FC<AIMemoryListProps> = React.memo(() => {
...
export const AIMemoryContent: React.FC<AIMemoryContentProps> = React.memo(
    (props) => {
        const { item } = props;
        ...
        return (
            <div className={styles['memory-popover-content']}>
                ...
                <div className={styles['memory-popover-potential-questions']}>
                    ...
                    {item.potential_questions.map((ele: string) => (
                        <div
                            className={styles['potential-questions-item']}
                            key={ele}
                            title={ele}
                        >
...
const AIMemoryScoreEcharts: React.FC<AIMemoryScoreEchartsProps> = React.memo(
    (props) => {
