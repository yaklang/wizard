...
const TimelineRow = memo(
    ({
        ...
        item: AIAgentGrpcApi.TimelineItem;
        ...
        return (
            ...
            >
                <div className={styles['timeline-card-header']}>
                    <div className={styles['timeline-card-header-left']}>
                        ...
                        >
                            <p
                                className={
                                    styles['timeline-card-header-tag-text']
                                }
                            >
                ...
                <div className={styles['timeline-card-body']}>
                    {item.content || ''}
                </div>
            </div>
        );
...
const VirtuosoItemContainer = forwardRef<
    HTMLDivElement,
    ItemProps<AIAgentGrpcApi.TimelineItem>
...
const TimelineCard: FC = () => {
    ...
    const { virtuosoRef, setScrollerRef, handleTotalListHeightChanged } =
        useVirtuosoAutoScroll({
            total: reActTimelines.length || 0,
