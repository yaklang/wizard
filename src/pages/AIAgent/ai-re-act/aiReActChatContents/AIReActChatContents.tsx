...
export const AIStreamNode: React.FC<AIStreamNodeProps> = React.memo((props) => {
    ...
    const { NodeId, content, NodeIdVerbose, CallToolID, ContentType } =
        stream.data;
...
export const AIReActChatContents: React.FC<AIReActChatContentsPProps> =
    React.memo((props) => {
        const { chats } = props;
        const {
                        ...
                        >
                            ...
                            >
                                {mode === 'value' ? (
                                    ...
                                    <ScrollText text={displayValue as string} />
                                )}
                            </div>
                        </Loading>
                    </div>
...
export const AIReferenceNode: React.FC<AIReferenceNodeProps> = React.memo(
    (props) => {
