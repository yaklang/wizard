...
import type { AIModelTypeEnum, AttachedResourceKeyEnum, AttachedResourceTypeEnum } from '../../ai-agent/defaultConstant'
import type { KnowledgeBaseEntry, KVPair } from '../../enums/external'
...
export declare namespace AIAgentGrpcApi {
  ...
  /** 插件结果数据 */
  export type AICardMessage = StreamResult.Message
  /** 插件结果-卡片数据 */
  export type AICard = StreamResult.Card
  export type AICacheCard = HoldGRPCStreamProps.CacheCard
  export type AIInfoCard = HoldGRPCStreamProps.InfoCards
