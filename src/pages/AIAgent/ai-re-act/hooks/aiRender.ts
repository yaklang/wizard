...
export type UITaskReview = AIAgentGrpcApi.TaskReviewRequire &
    ReviewSelectedOption;
export type UIToolUseReview = AIAgentGrpcApi.ToolUseReviewRequire &
    ReviewSelectedOption;
export type UIRequireUserInteractive = AIAgentGrpcApi.AIReviewRequire &
    ReviewSelectedOption;
export type UIExecAIForgeReview = AIAgentGrpcApi.ExecForgeReview &
    ReviewSelectedOption;
...
export interface AIToolCallDecision
    extends Omit<AIAgentGrpcApi.ToolCallDecision, 'i18n'> {
    i18n: AIOutputI18n;
}
...
/** 会话参参考资料 */
export type ChatReferenceMaterialPayload =
    AIAgentGrpcApi.ReferenceMaterialPayload[];
...
type ChatQuestion = AIChatQSDataBase<
    AIChatQSDataTypeEnum.QUESTION,
    { qs: string; setting: AIInputEvent }
>;
export type ChatStream = AIChatQSDataBase<
    AIChatQSDataTypeEnum.STREAM,
    AIStreamOutput
>;
type ChatToolCallResult = AIChatQSDataBase<
    AIChatQSDataTypeEnum.TOOL_CALL_RESULT,
    AIStreamOutput
>;
...
type ChatToolResult = AIChatQSDataBase<
    AIChatQSDataTypeEnum.TOOL_RESULT,
    AIToolResult
>;
type ChatPlanReviewRequire = AIChatQSDataBase<
    AIChatQSDataTypeEnum.PLAN_REVIEW_REQUIRE,
    UIPlanReview
>;
type ChatTaskReviewRequire = AIChatQSDataBase<
    AIChatQSDataTypeEnum.TASK_REVIEW_REQUIRE,
    UITaskReview
>;
type ChatToolUseReviewRequire = AIChatQSDataBase<
...
type ChatRequireUserInteractive = AIChatQSDataBase<
    ...
    UIRequireUserInteractive
>;
type ChatExecAIForgeReview = AIChatQSDataBase<
    AIChatQSDataTypeEnum.EXEC_AIFORGE_REVIEW_REQUIRE,
    UIExecAIForgeReview
>;
type ChatTaskIndexNode = AIChatQSDataBase<
    AIChatQSDataTypeEnum.TASK_INDEX_NODE,
    AITaskStartInfo
>;
export type ChatToolCallDecision = AIChatQSDataBase<
    AIChatQSDataTypeEnum.TOOL_CALL_DECISION,
    AIToolCallDecision
>;
type ChatPlanExecEnd = AIChatQSDataBase<
    AIChatQSDataTypeEnum.END_PLAN_AND_EXECUTION,
    string
>;
type ChatFailPlanAndExecution = AIChatQSDataBase<
    ...
    FailTaskChatError
>;
type ChatFailReact = AIChatQSDataBase<
    AIChatQSDataTypeEnum.FAIL_REACT,
    FailReactError
>;
