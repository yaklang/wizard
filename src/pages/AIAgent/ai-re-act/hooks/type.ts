...
import type { ChatDataStore } from '@/pages/AIAgent/ai-agent/store/ChatDataStore';
import type { CustomPluginExecuteFormValue } from '../../enums/external';
...
export type UseAIPerfDataParams = UseHookBaseParams;

export interface UseAIPerfDataEvents {
    handleSetData: (res: AIOutputEvent) => void;
}
// #endregion

// #region useYakExecResult相关定义
export type UseYakExecResultParams = UseHookBaseParams;
...
export type UseChatContentEvents = UseHookBaseEvents;
// #endregion
