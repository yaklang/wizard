...
import { AIAgentChatStream, AIChatLeftSide } from '../../ai-agent/chatTemplate/AIAgentChatTemplate'
...
const AIReActTaskChatContent: React.FC<AIReActTaskChatContentProps> = React.memo(() => {
  ...
  const getTaskId = useMemoizedFn(() => {
    return chatIPCEvents.fetchTaskChatID()?.taskID
  })
  /** 取消当前指定任务 */
          ...
          <div className={styles['footer']}>
            {!!getTaskId() && (
              <>
                ...
                <YakitPopconfirm onConfirm={onStopTask} title="是否确认取消整个任务，确认将停止执行" placement="top">
