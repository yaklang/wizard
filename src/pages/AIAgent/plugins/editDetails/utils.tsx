 ...
 */
export const convertRemoteToRemoteInfo = (
    info: API.PluginsDetail,
    ...
    if (modify) {
        ...
        request.params = modify.Params
            ? pluginParamsConvertLocalToOnline(modify.Params)
            : undefined;
    ...
    if ((request.pluginEnvKey || []).length === 0)
        request.pluginEnvKey = undefined;
 ...
 * @returns 返回处理好分组后的数据
 */
export const ParamsToGroupByGroupName = (
    arr: YakParamProps[],
): YakExtraParamProps[] => {
    let map = {};
...
/** @name 获取源码中的参数和风险信息 */
export const onCodeToInfo: APIFunc<
    PluginCodeToInfoRequest,
    CodeToInfoResponseProps | null
> = (params, hiddenError) => {
