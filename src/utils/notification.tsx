...
export const yakitInfo = (msg: string) => {
    yakitNotify('info', msg);
};
...
const getIcon = (type: string) => {
    switch (type) {
        case 'error':
            return (
                <CloseCircleIcon className="yakit-notify-icon yakit-notify-error-icon" />
            );
        case 'success':
            return (
                <CheckCircleOutlineIcon className="yakit-notify-icon yakit-notify-success-icon" />
            );
        case 'warning':
            return (
                <ExclamationOutlineIcon className="yakit-notify-icon yakit-notify-warning-icon" />
            );
        default:
            return null;
    }
