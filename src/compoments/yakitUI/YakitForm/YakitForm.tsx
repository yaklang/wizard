 ...
 */
export const YakitFormDragger: React.FC<YakitFormDraggerProps> = React.memo(
    (props) => {
        const {
            formItemProps = {},
            size,
...
export const YakitDragger: React.FC<YakitDraggerProps> = React.memo((props) => {
                ...
                return (
                    <YakitInput.TextArea
                        ...
                        onPressEnter={(e) => {
                            ...
                            if (textareaProps.onPressEnter)
                                textareaProps.onPressEnter(e);
                        }}
                        onFocus={(e) => {
                            e.stopPropagation();
    ...
    const afterFolderDrop = useMemoizedFn((e) => {
        ...
        if (filesLength > isNoFit.length && setFileName)
...
export const YakitDraggerContent: React.FC<YakitDraggerContentProps> =
    React.memo((props) => {
        const {
            value,
            disabled,
        ...
        return (
            ...
            >
                {renderContent(
                    <div
                        className={classNames(
                            styles['form-item-help'],
                            styles['form-item-content-help'],
                        )}
                    >
                        <label>
                            {help
...
export const YakitFormDraggerContent: React.FC<YakitFormDraggerContentProps> =
    React.memo((props) => {
        const {
            formItemProps = {},
            size,
