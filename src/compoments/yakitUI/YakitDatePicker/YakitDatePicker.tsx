...
import type {
    YakitDatePickerProps,
    YakitRangePickerProps,
} from './YakitDatePickerType';
    ...
    return (
        <div
            className={classNames(
                ...
                {
                    [styles['yakit-range-picker-wrapper-large']]:
                        size === 'large',
                    [styles['yakit-range-picker-wrapper-small']]:
                        size === 'small',
                },
                wrapperClassName,
            )}
        ...
        >
            <RangePicker
                ...
                dropdownClassName={classNames(
                    styles['yakit-range-picker-dropdaown'],
                    { dropdownClassName },
                )}
...
type CompoundedComponent =
    React.ForwardRefExoticComponent<YakitDatePickerProps> & {
