...
import type { MilkdownBaseUtilProps, TooltipListProps } from '../constants'
import { MilkdownMenu, MilkdownMenuKeyEnum, tooltipKey } from '../constants'
            ...
            {tooltipTextList.map((ele) => {
              ...
              return (
                <Tooltip key={item.key} title={item.description} placement="right">
                  <div key={item.key} className={styles['tooltip-list-item']} onClick={() => onText(item)}>
