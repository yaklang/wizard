    ...
    <>
      ...
      >
        {fileInfo.path || fileInfo.url ? (
                ...
                <>
                  {loading ? (
                    ...
                    <div className={styles['success-action']}>
                      {fileInfo.url && <TooltipIcon title="下载文件" icon={<OutlineDownloadIcon />} onClick={onDown} />}
          ...
          <YakitSpin size="small" spinning={true} tip="文件加载中..." wrapperClassName={styles['file-spinning']} />
        )}
      </div>
      {downFileInfo && (
        <DownFilesModal
