...
type FilterSearchMultipleProps = SelectProps;
 ...
 * @property {"select" | "input"}  filtersType  搜索的类型
 ...
 * @property {InputProps}  filterInputProps  input的props属性
 */
export interface FilterProps {
    ...
    filterInputProps?: InputProps; // input的props属性
}
/**
...
export interface SelectSearchProps {
    ...
    onSelect: (
        f: string | string[],
        record?: FiltersItemProps | FiltersItemProps[],
    ) => void;
    value: string | string[];
    filterProps?: FilterProps;
    onClose: () => void;
