 ...
 * @description: 原生 多选框
 */
export const YakitProtoCheckbox: React.FC<YakitProtoCheckboxProps> = React.memo(
    (props) => {
        const { wrapperClassName, indeterminate, wrapperStyle, ...resProps } =
            props;
        ...
        return (
            <label
                className={classNames(
                    styles['yakit-proto-checkbox-wrapper'],
                    wrapperClassName,
                )}
                style={{ ...wrapperStyle }}
            >
                <span
                    className={classNames(styles['yakit-proto-checkbox'], {
                        ...
                        [styles['yakit-checkbox-checked-focus']]:
                            props.checked && focus,
                ...
                >
                    ...
                    <span
                        className={classNames(
                            styles['yakit-proto-checkbox-inner'],
                        )}
                    />
                </span>
            </label>
