 ...
 * @description: 开关
 */
export const YakitProtoSwitch: React.FC<YakitProtoSwitchProps> = React.memo(
    (props) => {
        const { wrapperClassName, wrapperStyle, checked, onChange, disabled } =
            props;
            ...
            <label
                className={classNames(
                    styles['yakit-proto-switch-wrapper'],
                    {
                        ...
                        [styles['yakit-proto-switch-wrapper-checked-focus']]:
                            checked && focus,
                        [styles['yakit-proto-switch-wrapper-disabled']]:
                            disabled,
                    },
                    wrapperClassName,
                )}
