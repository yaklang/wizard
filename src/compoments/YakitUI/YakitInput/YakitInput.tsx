 ...
 */
const InternalInput: React.FC<YakitInputProps & React.RefAttributes<InputRef>> =
    forwardRef((props, ref: React.Ref<InputRef>) => {
        const {
            size,
            wrapperClassName,
            className,
...
const InternalSearch: React.FC<
    YakitInputSearchProps & React.RefAttributes<InputRef>
> = forwardRef((props, ref: React.Ref<InputRef>) => {
    const { size, wrapperClassName, className, wrapperStyle, ...restProps } =
        props;
        ...
        <div
            className={classNames(
                styles['yakit-search-wrapper'],
                {
                    ...
                    [styles['yakit-search-wrapper-maxLarge']]:
                        size === 'maxLarge',
...
const InternalTextArea: React.FC<
    InternalTextAreaProps & React.RefAttributes<TextAreaRef>
> = forwardRef((props, ref: React.Ref<TextAreaRef>) => {
    const {
        wrapperClassName,
        wrapperStyle,
        isShowResize = true,
...
const InternalInputPassword: React.FC<
    InternalInputPasswordProps & React.RefAttributes<InputRef>
> = forwardRef((props, ref: React.Ref<InputRef>) => {
    const { wrapperClassName, wrapperStyle, size, ...restProps } = props;
    return (
        <div
            className={classNames(
...
type CompoundedComponent = React.ForwardRefExoticComponent<
    YakitInputProps & React.RefAttributes<InputRef>
> & {
