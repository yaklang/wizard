 ...
 */
export const YakitAutoComplete: React.FC<YakitAutoCompleteProps> =
    React.forwardRef((props, ref) => {
        ...
        const [cacheHistoryData] =
            useState<YakitAutoCompleteCacheDataHistoryProps>({
                options: [],
                defaultValue: '',
            });
        useEffect(() => {
        ...
        const onGetRemoteValues = useMemoizedFn((init?: boolean) => {
            ...
            //     .then((cacheData: any) => {
            //         let value = cacheData.defaultValue
        ...
        const delCatchOptionItem = (
            e: React.MouseEvent<Element, MouseEvent>,
            item: YakitOptionTypeProps,
        ) => {
            e.stopPropagation();
            if (cacheHistoryDataKey && item) {
                // onSetRemoteValuesBase({
                //     cacheHistoryDataKey,
                //     newValue: '',
                //     isCacheDefaultValue,
        ...
        const renderItem = (item: YakitOptionTypeProps) => {
            ...
            copyItem.label = (
                ...
                >
                    <div className={styles['yakit-option-item-label']}>
                        {copyItem.label}
                    </div>
                    <OutlineXIcon
                        style={{
                            display:
                                mouseEnterItem === item.value &&
        ...
        return (
            <div
                ...
                className={classNames(styles['yakit-auto-complete-wrapper'], {
                    [styles['yakit-auto-complete-wrapper-large']]:
                        size === 'large',
                    [styles['yakit-auto-complete-wrapper-small']]:
                        size === 'small',
