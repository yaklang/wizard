...
export const YakitSideTab: FC<YakitSideTabProps> = memo((props) => {
    const {
        yakitTabs,
        activeKey,
        onActiveKey,
                                ...
                                <YakitTabsItem
                                    ...
                                    className={classNames(
                                        ...
                                        btnItemClassName,
                                        {
                                            ...
                                            [styles[
                                                'yakit-side-tab-item-active-noHover'
                                            ]]:
                                                item.value === activeKey &&
                                                activeShow,
                                            [styles[
        ...
        <div
            className={classNames(
                styles['tab-wrap'],
                {
                    ...
                    [styles['tab-wrap-vertical-right']]:
                        type === 'vertical-right',
                },
                className,
            )}
...
const YakitTabsItem: React.FC<YakitTabsItemProps> = memo((props) => {
    const {
        item,
        onChange,
        className = '',
