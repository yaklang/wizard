...
import type { getReverseConfigResponse, PostReverseConfigRequest } from './types'

const postReverseConfig = (data: PostReverseConfigRequest): Promise<ResponseData<boolean>> =>
